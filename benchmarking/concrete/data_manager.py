"""Benchmarking DataManager for the Concrete dataset
"""
...
from pyrelational.datasets.regression.uci import UCIConcrete


def get_concrete_data_manager() -> DataManager:
    ds = UCIConcrete()
    print(len(ds))
    train_ds, valid_ds, test_ds = torch.utils.data.random_split(ds, [800, 30, 200])
