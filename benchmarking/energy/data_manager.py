...
from pyrelational.datasets.regression.uci import UCIEnergy


def get_energy_data_manager() -> DataManager:
    ds = UCIEnergy()
    train_ds, valid_ds, test_ds = torch.utils.data.random_split(ds, [400, 100, 268])
