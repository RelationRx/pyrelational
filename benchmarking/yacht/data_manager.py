...
from pyrelational.datasets.regression.uci import UCIYacht


def get_yacht_data_manager() -> DataManager:
    ds = UCIYacht()
    train_ds, valid_ds, test_ds = torch.utils.data.random_split(ds, [180, 20, 106])
    ...
    return DataManager(
        ...
        labelled_indices=np.random.choice(train_indices, 20, replace=False).tolist(),
