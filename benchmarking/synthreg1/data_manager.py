"""Benchmarking DataManager for the SynthReg1 dataset
"""
...
from pyrelational.datasets.regression.synthetic import SynthReg1


def get_synthreg1_data_manager() -> DataManager:
    ds = SynthReg1()
