"""Benchmarking DataManager for the wine dataset
"""
...
from pyrelational.datasets.regression.uci import UCIWine


def get_wine_data_manager() -> DataManager:
    ds = UCIWine()
    print(len(ds))
    train_ds, valid_ds, test_ds = torch.utils.data.random_split(ds, [1000, 100, 498])
