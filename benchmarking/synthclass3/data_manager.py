...
"""Benchmarking DataManager for the SynthClass3 dataset
"""
import random
import time
...
from pyrelational.datasets.classification.synthetic import SynthClass3
...
def get_synthclass3_data_manager(seed: int) -> DataManager:
    ds = SynthClass3(random_seed=seed)
