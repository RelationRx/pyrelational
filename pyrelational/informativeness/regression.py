...
def _compute_mean(x: Optional[Union[Distribution, Tensor]], axis: int = 0) -> Union[Tensor, Any]:
    """
...
def _compute_std(x: Optional[Union[Distribution, Tensor]], axis: int = 0) -> Union[Tensor, Any]:
    """
